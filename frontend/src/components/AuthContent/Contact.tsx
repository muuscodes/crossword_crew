export default function Contact() {
  return (
    <div className="min-h-screen flex flex-col items-center m-auto">
      ...
      >
        <label htmlFor="username" className="m-1 bigger">
          Username
        </label>
        <input
          type="text"
          name="username"
          id="username"
          className="border-1 m-2 bigger"
        />
        <label htmlFor="email" className="m-1 bigger">
          Email
        </label>
        <input
          type="email"
          ...
          className="border-1 m-2 bigger"
        />
        <label htmlFor="message" className="m-1 bigger">
          Message
        </label>
        <textarea
          name="message"
          id="message"
          className="border-1 h-full m-2 bigger"
        ></textarea>
